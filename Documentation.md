...
Overview
QuoteVault is an iOS application developed in SwiftUI with a Supabase backend, focused on discovering, organizing, and sharing quotes. Key features: authentication, cloud synchronization, personalization, favorites management, quotes feed, tab navigation, quote sharing, quote of the day, and strategic use of AI tools during development.
